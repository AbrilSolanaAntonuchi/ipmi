...
if (tiempoActual < tiempo) {
  ...
  estado = 1;
} else if (tiempoActual < tiempo2) {
  estado = 2;
} else if (tiempoActual < tiempo3) {
  estado = 3;
} else if (tiempoActual < tiempo4) {
  estado = 4;
} else if (tiempoActual < tiempo5) {
  estado = 5;
} else if (tiempoActual < tiempo6) {
  estado = 6;
} else if (tiempoActual < tiempo7) {
  estado = 7;
} else if (tiempoActual < tiempo8) {
  estado = 8;
} else if (tiempoActual < tiempo9) {
  estado = 9;
} else if (tiempoActual < tiempo10) {
  estado = 10;
} else {
  estado = 11;
}
